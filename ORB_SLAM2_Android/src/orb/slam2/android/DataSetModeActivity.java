...
public class DataSetModeActivity extends Activity implements OnClickListener{
	...
	TextView DatasetTxt,CalibrationTxt;
	
	private static final int REQUEST_CODE_1 = 1;   //图片地址请求码
	private static final int REQUEST_CODE_2 = 2;   //VOC文件请求码
	private Intent fileChooserIntent ;
	public static final String EXTRA_FILE_CHOOSER = "file_chooser";
	
	private String PICPath,TUMPath;
	...
	public void onClick(View v) {
		...
		case R.id.choose_calibration:
			...
			break;
		case R.id.finish:
			if(!TextUtils.isEmpty(PICPath)&&!TextUtils.isEmpty(TUMPath)){
				startActivity(new Intent(DataSetModeActivity.this,ORBSLAMActivity.class));
				finish();
			}else{
